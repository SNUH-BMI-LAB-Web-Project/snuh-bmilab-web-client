...
export class AdminUserApi extends runtime.BaseAPI {
    ...
    async updateUserStatusRaw(requestParameters: UpdateUserStatusOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters['updateUserStatusRequest'] == null) {
            throw new runtime.RequiredError(
                'updateUserStatusRequest',
                'Required parameter "updateUserStatusRequest" was null or undefined when calling updateUserStatus().'
            );
        }
        ...
        const response = await this.request({
            path: `/admin/users/{userId}/status`.replace(`{${"userId"}}`, encodeURIComponent(String(requestParameters['userId']))),
            method: 'PATCH',
            headers: headerParameters,
            query: queryParameters,
    ...
    async updateUserStatus(requestParameters: UpdateUserStatusOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.updateUserStatusRaw(requestParameters, initOverrides);
    }
