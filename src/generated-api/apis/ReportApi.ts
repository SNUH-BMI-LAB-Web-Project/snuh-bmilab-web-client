...
import type { ReportFindAllResponse, ReportRequest } from '../models/index';
import {
...
export class ReportApi extends runtime.BaseAPI {
   ...
   * 일일 업무 보고 삭제
   */
  async deleteReportRaw(
    requestParameters: DeleteReportRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * 내 업무보고 엑셀파일 다운로드
   */
  async getExcelFileByCurrentUserRaw(
    requestParameters: GetExcelFileByCurrentUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * 내 업무보고 엑셀파일 다운로드
   */
  async getExcelFileByCurrentUser(
    requestParameters: GetExcelFileByCurrentUserRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Blob> {
    const response = await this.getExcelFileByCurrentUserRaw(
      requestParameters,
      initOverrides,
    );
   ...
   * 내 일일 업무 보고 조회
   */
  async getReportsByCurrentUserRaw(
    requestParameters: GetReportsByCurrentUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * 내 일일 업무 보고 조회
   */
  async getReportsByCurrentUser(
    requestParameters: GetReportsByCurrentUserRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ReportFindAllResponse> {
    const response = await this.getReportsByCurrentUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * 내 업무보고 워드파일 다운로드
   */
  async getWordFileByCurrentUserRaw(
    requestParameters: GetWordFileByCurrentUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Blob>> {
    const queryParameters: any = {};
   ...
   * 내 업무보고 워드파일 다운로드
   */
  async getWordFileByCurrentUser(
    requestParameters: GetWordFileByCurrentUserRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Blob> {
    const response = await this.getWordFileByCurrentUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * 일일 업무 보고 수정
   */
  async updateReportRaw(
    requestParameters: UpdateReportRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['reportId'] == null) {
      throw new runtime.RequiredError(
