...
export class UserApi extends runtime.BaseAPI {
   ...
   * 사용자 학력 추가
   */
  async addEducationsRaw(
    requestParameters: AddEducationsRequest,
    ...
    const response = await this.request(
      {
        ...
        body: UserEducationRequestToJSON(
          requestParameters['userEducationRequest'],
        ),
      },
      initOverrides,
    );
   ...
   * 사용자 학력 삭제
   */
  async deleteEducationsRaw(
    requestParameters: DeleteEducationsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/users/me/educations/{educationId}`.replace(
          `{${'educationId'}}`,
          encodeURIComponent(String(requestParameters['educationId'])),
        ),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
  ...
  async getAllUsersRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserFindAllResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UserFindAllResponseFromJSON(jsonValue),
    );
  }
  ...
  async searchUsersRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SearchUserResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SearchUserResponseFromJSON(jsonValue),
    );
  }
  ...
  async searchUsers(
    ...
    const response = await this.searchUsersRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * 이메일로 비밀번호 재설정
   */
  async sendFindPasswordEmailRaw(
    requestParameters: SendFindPasswordEmailRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: FindPasswordEmailRequestToJSON(
          requestParameters['findPasswordEmailRequest'],
        ),
      },
      initOverrides,
    );
    ...
    if (requestParameters['request'] != null) {
      formParams.append(
        ...
        new Blob(
          [
            JSON.stringify(
              UpdateUserRequestToJSON(requestParameters['request']),
            ),
          ],
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UpdateUserPasswordRequestToJSON(
