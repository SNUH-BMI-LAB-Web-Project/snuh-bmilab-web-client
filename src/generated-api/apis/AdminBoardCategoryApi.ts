...
import type { BoardCategoryReqeust } from '../models/index';
import {
...
export class AdminBoardCategoryApi extends runtime.BaseAPI {
   ...
   * 게시판 분야 추가
   */
  async createBoardCategoryRaw(
    requestParameters: CreateBoardCategoryRequest,
    ...
    const response = await this.request(
      {
        ...
        body: BoardCategoryReqeustToJSON(
          requestParameters['boardCategoryReqeust'],
        ),
      },
      initOverrides,
    );
   ...
   * 게시판 분야 삭제
   */
  async deleteBoardCategoryRaw(
    requestParameters: DeleteBoardCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        path: `/admin/boards/categories/{categoryId}`.replace(
          `{${'categoryId'}}`,
   ...
   * 게시판 분야 수정
   */
  async updateBoardCategoryRaw(
    requestParameters: UpdateBoardCategoryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['categoryId'] == null) {
      throw new runtime.RequiredError(
