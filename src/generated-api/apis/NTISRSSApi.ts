...
import type { ErrorResponse, RSSResponse } from '../models/index';
import {
...
export class NTISRSSApi extends runtime.BaseAPI {
   ...
   * RSS 데이터 조회
   */
  async getAllRssAssignmentsRaw(
    requestParameters: GetAllRssAssignmentsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<RSSResponse>> {
   ...
   * RSS 데이터 조회
   */
  async getAllRssAssignments(
    requestParameters: GetAllRssAssignmentsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<RSSResponse> {
    const response = await this.getAllRssAssignmentsRaw(
      requestParameters,
      initOverrides,
    );
...
export type GetAllRssAssignmentsSearchTypeEnum =
  (typeof GetAllRssAssignmentsSearchTypeEnum)[keyof typeof GetAllRssAssignmentsSearchTypeEnum];
