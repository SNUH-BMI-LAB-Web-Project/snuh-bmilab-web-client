...
export class FileApi extends runtime.BaseAPI {
   ...
   * Presigned URL 발급
   */
  async generatePresignedUrlRaw(
    requestParameters: GeneratePresignedUrlRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<FilePresignedUrlResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      FilePresignedUrlResponseFromJSON(jsonValue),
    );
  }
  ...
  async generatePresignedUrl(
    ...
    const response = await this.generatePresignedUrlRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async uploadFileRaw(
    requestParameters: UploadFileOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<FileSummary>> {
