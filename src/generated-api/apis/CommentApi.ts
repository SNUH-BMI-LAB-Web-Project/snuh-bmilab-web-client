...
import type { CommentFindAllResponse, CommentRequest } from '../models/index';
import {
...
export class CommentApi extends runtime.BaseAPI {
  ...
  async deleteCommentRaw(
    ...
    const response = await this.request(
      {
        path: `/comments/{commentId}`.replace(
          `{${'commentId'}}`,
   ...
   * 댓글 목록 조회
   */
  async getAllCommentsRaw(
    requestParameters: GetAllCommentsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<CommentFindAllResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      CommentFindAllResponseFromJSON(jsonValue),
    );
  }
  ...
  async getAllComments(
    requestParameters: GetAllCommentsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<CommentFindAllResponse> {
    const response = await this.getAllCommentsRaw(
      requestParameters,
      initOverrides,
    );
...
export type GetAllCommentsDomainTypeEnum =
  (typeof GetAllCommentsDomainTypeEnum)[keyof typeof GetAllCommentsDomainTypeEnum];
