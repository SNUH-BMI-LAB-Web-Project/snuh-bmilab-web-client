...
export class LeaveApi extends runtime.BaseAPI {
   ...
   */
  async applyLeaveRaw(
    requestParameters: ApplyLeaveOperationRequest,
   ...
   * 사용자 휴가 조회
   */
  async getLeavesByUserRaw(
    requestParameters: GetLeavesByUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserLeaveResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UserLeaveResponseFromJSON(jsonValue),
    );
  }
  ...
  async getLeavesByUser(
    requestParameters: GetLeavesByUserRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<UserLeaveResponse> {
    const response = await this.getLeavesByUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
