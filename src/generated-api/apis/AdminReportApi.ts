...
import type { ReportFindAllResponse } from '../models/index';
import {
...
export class AdminReportApi extends runtime.BaseAPI {
   ...
   * 일별 보고 엑셀파일 다운로드
   */
  async createReportExcelRaw(
    requestParameters: CreateReportExcelRequest,
  ...
  async createReportExcel(
    ...
    const response = await this.createReportExcelRaw(
      requestParameters,
      initOverrides,
    );
   ...
   * 일일 업무 보고 조회
   */
  async getReportsByAllUserRaw(
    requestParameters: GetReportsByAllUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * 일일 업무 보고 조회
   */
  async getReportsByAllUser(
    requestParameters: GetReportsByAllUserRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ReportFindAllResponse> {
    const response = await this.getReportsByAllUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * 일별 보고 워드파일 다운로드
   */
  async getWordFileByCurrentUser1Raw(
    requestParameters: GetWordFileByCurrentUser1Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Blob>> {
    if (requestParameters['startDate'] == null) {
      throw new runtime.RequiredError(
   ...
   * 일별 보고 워드파일 다운로드
   */
  async getWordFileByCurrentUser1(
    requestParameters: GetWordFileByCurrentUser1Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Blob> {
    const response = await this.getWordFileByCurrentUser1Raw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * 일별 보고 메일 본문 미리보기
   */
  async previewMailBodyRaw(
    requestParameters: PreviewMailBodyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * 일별 보고 메일 본문 미리보기
   */
  async previewMailBody(
    requestParameters: PreviewMailBodyRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<string> {
    const response = await this.previewMailBodyRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
