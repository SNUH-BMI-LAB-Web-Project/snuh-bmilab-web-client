...
export class ProjectApi extends runtime.BaseAPI {
  ...
  async completeProjectRaw(
    ...
    const response = await this.request(
      {
        path: `/projects/{projectId}/complete`.replace(
          `{${'projectId'}}`,
        ...
        body: ProjectCompleteRequestToJSON(
          requestParameters['projectCompleteRequest'],
        ),
      },
      initOverrides,
    );
   ...
   * 신규 연구 생성
   */
  async createNewProjectRaw(
    requestParameters: CreateNewProjectRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
   ...
   * 연구 삭제
   */
  async deleteProjectByIdRaw(
    requestParameters: DeleteProjectByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['projectId'] == null) {
      throw new runtime.RequiredError(
   ...
   * 연구 첨부파일 삭제
   */
  async deleteProjectFileRaw(
    requestParameters: DeleteProjectFileRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['projectId'] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async downloadDrbFilesByZipRaw(
    requestParameters: DownloadDrbFilesByZipRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ...
    const response = await this.request(
      {
        path: `/projects/{projectId}/files/drb`.replace(
          `{${'projectId'}}`,
          encodeURIComponent(String(requestParameters['projectId'])),
        ),
        method: 'GET',
  ...
  /**
   */
  async downloadDrbFilesByZip(
    requestParameters: DownloadDrbFilesByZipRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<object> {
    const response = await this.downloadDrbFilesByZipRaw(
      requestParameters,
      initOverrides,
    );
  ...
  /**
   */
  async downloadIrbFilesByZipRaw(
    requestParameters: DownloadIrbFilesByZipRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<object>> {
    if (requestParameters['projectId'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/projects/{projectId}/files/irb`.replace(
          `{${'projectId'}}`,
          encodeURIComponent(String(requestParameters['projectId'])),
        ),
        method: 'GET',
  ...
  /**
   */
  async downloadIrbFilesByZip(
    requestParameters: DownloadIrbFilesByZipRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<object> {
    const response = await this.downloadIrbFilesByZipRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * 연구 자료실 첨부파일 조회
   */
  async getAllProjectFilesRaw(
    requestParameters: GetAllProjectFilesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ProjectFileFindAllResponse>> {
    if (requestParameters['projectId'] == null) {
      throw new runtime.RequiredError(
        'projectId',
    ...
    const response = await this.request(
      {
        path: `/projects/{projectId}/files`.replace(
          `{${'projectId'}}`,
          encodeURIComponent(String(requestParameters['projectId'])),
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ProjectFileFindAllResponseFromJSON(jsonValue),
    );
  }
  ...
  async getAllProjectFiles(
    requestParameters: GetAllProjectFilesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ProjectFileFindAllResponse> {
    const response = await this.getAllProjectFilesRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async getAllProjectsRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ProjectFindAllResponse>> {
    const queryParameters: any = {};
    ...
    if (requestParameters['practicalProfessor'] != null) {
      queryParameters['practicalProfessor'] =
        requestParameters['practicalProfessor'];
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ProjectFindAllResponseFromJSON(jsonValue),
    );
  }
  ...
  async getAllProjects(
    ...
    const response = await this.getAllProjectsRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * 외부교수 목록 조회
   */
  async getExternalProfessorsRaw(
    requestParameters: GetExternalProfessorsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * 외부교수 목록 조회
   */
  async getExternalProfessors(
    requestParameters: GetExternalProfessorsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ExternalProfessorFindAllResponse> {
    const response = await this.getExternalProfessorsRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * 내 연구 조회
   */
  async getMyProjectsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserProjectFindAllResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UserProjectFindAllResponseFromJSON(jsonValue),
    );
  }
  ...
  async getMyProjects(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<UserProjectFindAllResponse> {
  ...
  async getProjectByIdRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ProjectDetail>> {
    if (requestParameters['projectId'] == null) {
      throw new runtime.RequiredError(
        'projectId',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ProjectDetailFromJSON(jsonValue),
    );
  }
   ...
   * 연구와 연관된 일일보고 목록 조회
   */
  async getReportsByProjectRaw(
    requestParameters: GetReportsByProjectRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ReportFindAllResponse>> {
    if (requestParameters['projectId'] == null) {
      throw new runtime.RequiredError(
        'projectId',
    ...
    const response = await this.request(
      {
        path: `/projects/{projectId}/reports`.replace(
          `{${'projectId'}}`,
          encodeURIComponent(String(requestParameters['projectId'])),
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ReportFindAllResponseFromJSON(jsonValue),
    );
  }
  ...
  async getReportsByProject(
    requestParameters: GetReportsByProjectRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ReportFindAllResponse> {
    const response = await this.getReportsByProjectRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * 사용자 연구 조회
   */
  async getUserProjectsRaw(
    requestParameters: GetUserProjectsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserProjectFindAllResponse>> {
    if (requestParameters['userId'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/projects/users/{userId}`.replace(
          `{${'userId'}}`,
  ...
  async getUserProjects(
    ...
    const response = await this.getUserProjectsRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * 연구 검색
   */
  async searchProjectRaw(
    requestParameters: SearchProjectRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SearchProjectResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SearchProjectResponseFromJSON(jsonValue),
    );
  }
  ...
  async searchProject(
    ...
    const response = await this.searchProjectRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
...
export type GetAllProjectsStatusEnum =
  (typeof GetAllProjectsStatusEnum)[keyof typeof GetAllProjectsStatusEnum];
