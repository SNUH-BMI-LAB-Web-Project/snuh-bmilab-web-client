...
export type CommentSummaryDomainTypeEnum =
  (typeof CommentSummaryDomainTypeEnum)[keyof typeof CommentSummaryDomainTypeEnum];

/**
 * Check if a given object implements the CommentSummary interface.
 */
export function instanceOfCommentSummary(
  value: object,
): value is CommentSummary {
  return true;
}
...
export function CommentSummaryFromJSONTyped(
  json: any,
...
export function CommentSummaryToJSONTyped(
  value?: CommentSummary | null,
