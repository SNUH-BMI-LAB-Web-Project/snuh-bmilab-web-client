...
export type ProjectSummaryStatusEnum =
  (typeof ProjectSummaryStatusEnum)[keyof typeof ProjectSummaryStatusEnum];

/**
 * Check if a given object implements the ProjectSummary interface.
 */
export function instanceOfProjectSummary(
  value: object,
...
export function ProjectSummaryFromJSONTyped(
  json: any,
  ...
  return {
    ...
    participantCount:
      json['participantCount'] == null ? undefined : json['participantCount'],
...
export function ProjectSummaryToJSONTyped(
