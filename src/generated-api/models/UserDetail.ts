...
export type UserDetailPositionEnum =
  (typeof UserDetailPositionEnum)[keyof typeof UserDetailPositionEnum];
...
export type UserDetailRoleEnum =
  (typeof UserDetailRoleEnum)[keyof typeof UserDetailRoleEnum];
  ...
  return {
    ...
    educations:
      json['educations'] == null
        ? undefined
        : (json['educations'] as Array<any>).map(UserEducationSummaryFromJSON),
  ...
  return {
    ...
    educations:
      value['educations'] == null
        ? undefined
        : (value['educations'] as Array<any>).map(UserEducationSummaryToJSON),
