...
export type UserEducationRequestStatusEnum =
  (typeof UserEducationRequestStatusEnum)[keyof typeof UserEducationRequestStatusEnum];
...
export type UserEducationRequestTypeEnum =
  (typeof UserEducationRequestTypeEnum)[keyof typeof UserEducationRequestTypeEnum];

/**
 * Check if a given object implements the UserEducationRequest interface.
 */
export function instanceOfUserEducationRequest(
  value: object,
): value is UserEducationRequest {
  if (!('title' in value) || value['title'] === undefined) return false;
  if (!('status' in value) || value['status'] === undefined) return false;
  if (!('type' in value) || value['type'] === undefined) return false;
  if (!('startYearMonth' in value) || value['startYearMonth'] === undefined)
    return false;
  return true;
}
...
export function UserEducationRequestFromJSONTyped(
  json: any,
...
export function UserEducationRequestToJSONTyped(
  value?: UserEducationRequest | null,
