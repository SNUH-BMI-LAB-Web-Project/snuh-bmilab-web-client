...
export type ProjectFileSummaryFileTypeEnum =
  (typeof ProjectFileSummaryFileTypeEnum)[keyof typeof ProjectFileSummaryFileTypeEnum];

/**
 * Check if a given object implements the ProjectFileSummary interface.
 */
export function instanceOfProjectFileSummary(
  value: object,
): value is ProjectFileSummary {
  return true;
}
...
export function ProjectFileSummaryFromJSONTyped(
  json: any,
...
export function ProjectFileSummaryToJSONTyped(
  value?: ProjectFileSummary | null,
