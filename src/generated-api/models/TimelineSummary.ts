...
export type TimelineSummaryTimelineTypeEnum =
  (typeof TimelineSummaryTimelineTypeEnum)[keyof typeof TimelineSummaryTimelineTypeEnum];

/**
 * Check if a given object implements the TimelineSummary interface.
 */
export function instanceOfTimelineSummary(
  value: object,
): value is TimelineSummary {
  return true;
}
...
export function TimelineSummaryFromJSONTyped(
  json: any,
  ...
  return {
    ...
    recorder:
      json['recorder'] == null
        ? undefined
        : UserSummaryFromJSON(json['recorder']),
    title: json['title'] == null ? undefined : json['title'],
    date: json['date'] == null ? undefined : new Date(json['date']),
    startTime: json['startTime'] == null ? undefined : json['startTime'],
    endTime: json['endTime'] == null ? undefined : json['endTime'],
    meetingPlace:
      json['meetingPlace'] == null ? undefined : json['meetingPlace'],
    timelineType:
      json['timelineType'] == null ? undefined : json['timelineType'],
...
export function TimelineSummaryToJSONTyped(
  value?: TimelineSummary | null,
