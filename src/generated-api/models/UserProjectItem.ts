...
export type UserProjectItemStatusEnum =
  (typeof UserProjectItemStatusEnum)[keyof typeof UserProjectItemStatusEnum];

/**
 * Check if a given object implements the UserProjectItem interface.
 */
export function instanceOfUserProjectItem(
  value: object,
): value is UserProjectItem {
  return true;
}
...
export function UserProjectItemFromJSONTyped(
  json: any,
...
export function UserProjectItemToJSONTyped(
  value?: UserProjectItem | null,
