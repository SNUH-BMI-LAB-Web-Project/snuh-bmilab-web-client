 ...
 */
export function instanceOfProjectCategoryRequest(
  value: object,
): value is ProjectCategoryRequest {
  if (!('name' in value) || value['name'] === undefined) return false;
  return true;
}

export function ProjectCategoryRequestFromJSON(
  json: any,
): ProjectCategoryRequest {
  return ProjectCategoryRequestFromJSONTyped(json, false);
}

export function ProjectCategoryRequestFromJSONTyped(
  json: any,
...
export function ProjectCategoryRequestToJSON(
  json: any,
): ProjectCategoryRequest {
  return ProjectCategoryRequestToJSONTyped(json, false);
}

export function ProjectCategoryRequestToJSONTyped(
  value?: ProjectCategoryRequest | null,
