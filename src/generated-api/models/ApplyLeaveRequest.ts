...
export type ApplyLeaveRequestTypeEnum =
  (typeof ApplyLeaveRequestTypeEnum)[keyof typeof ApplyLeaveRequestTypeEnum];

/**
 * Check if a given object implements the ApplyLeaveRequest interface.
 */
export function instanceOfApplyLeaveRequest(
  value: object,
): value is ApplyLeaveRequest {
...
export function ApplyLeaveRequestFromJSONTyped(
  json: any,
...
export function ApplyLeaveRequestToJSONTyped(
  value?: ApplyLeaveRequest | null,
