...
export type LeaveDetailStatusEnum = typeof LeaveDetailStatusEnum[keyof typeof LeaveDetailStatusEnum];
...
export function LeaveDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeaveDetail {
    if (json == null) {
        return json;
    }
    return {
...
export function LeaveDetailToJSONTyped(value?: LeaveDetail | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
