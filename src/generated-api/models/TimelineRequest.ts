...
export type TimelineRequestTypeEnum =
  (typeof TimelineRequestTypeEnum)[keyof typeof TimelineRequestTypeEnum];

/**
 * Check if a given object implements the TimelineRequest interface.
 */
export function instanceOfTimelineRequest(
  value: object,
): value is TimelineRequest {
...
export function TimelineRequestFromJSONTyped(
  json: any,
...
export function TimelineRequestToJSONTyped(
  value?: TimelineRequest | null,
