...
const getProjectColumns = (currentPage: number, itemsPerPage: number) => [
  ...
  {
    label: '작성기관',
    className: 'text-center truncate overflow-hidden whitespace-nowrap w-[150px]',
  ...
  },
  {
    ...
    cell: (row: RSSItem) =>
      `${row.startDate ? formatDateTimeVer3(row.startDate) : ''} ~ ${
        row.endDate ? formatDateTimeVer3(row.endDate) : ''
      }`,
  },
  {
    label: '공고금액',
...
export default function RssClient() {
  ...
  useEffect(() => {
    ...
    fetchRSS();
  }, [currentPage, itemsPerPage, committedSearchTerm, minBudget, maxBudget, searchType]);
          ...
          <div className="flex flex-row gap-4">
            ...
            <div className="relative w-full">
              <Input
                ...
                onChange={(e) => {
                  ...
                  if (value !== undefined && maxBudget !== undefined && value > maxBudget) {
            ...
            <div className="relative w-full">
              <Input
                ...
                onChange={(e) => {
                  const value = e.target.value ? Number(e.target.value) : undefined;
                  if (value !== undefined && minBudget !== undefined && value < minBudget) {
