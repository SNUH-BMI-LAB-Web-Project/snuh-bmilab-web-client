    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">과제 관리 시스템</h1>
          </div>
          <Button onClick={handleAddTask}>
            <Plus className="mr-2 h-4 w-4" />새 과제 등록
          </Button>
        </div>
      </div>
      ...
      <main className="container mx-auto py-8">
        <div className="mb-10 grid grid-cols-1 gap-6 md:grid-cols-5">
          <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <p className="text-sm text-gray-500">총 과제</p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <div className="mb-3 flex items-center justify-between">
              <h3 className="text-sm font-semibold text-gray-700">
            ...
            <p className="text-sm text-gray-500">연차수 진행 중</p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <div className="mb-3 flex items-center justify-between">
              <h3 className="text-sm font-semibold text-gray-700">
            ...
            <p className="text-sm text-gray-500">제안서 준비 중</p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <div className="mb-3 flex items-center justify-between">
              <h3 className="text-sm font-semibold text-gray-700">
            ...
            <p className="text-sm text-gray-500">발표 준비 중</p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <div className="mb-3 flex items-center justify-between">
              <h3 className="text-sm font-semibold text-gray-700">
            ...
            <div className="mb-1 text-3xl font-bold text-gray-900">
              {stats.contractProgress}
            </div>
            <p className="text-sm text-gray-500">협약 진행 중</p>
          </div>
        </div>
          ...
          <div className="space-y-6">
            {filteredTasks.map((task) => {
              return (
                <div
                  key={task.id}
                  className="cursor-pointer overflow-hidden rounded-xl border border-gray-200 bg-white transition-all duration-300 hover:border-blue-300 hover:shadow-lg"
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <p className="pl-6 text-sm font-medium text-gray-900">
                              {task.snuhPI}
                            </p>
                          </div>
                          <div>
