...
import { BookOpen, Plus, Edit, Trash2, Save, X, Building2 } from 'lucide-react';
import {
...
export default function AffiliationModal() {
  ...
  const [affiliations, setAffiliations] = useState<ProjectCategorySummary[]>(
    [],
  );
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg">
                  <Plus className="h-5 w-5 text-green-600" />새 소속 추가
                </CardTitle>
              </CardHeader>
              <CardContent>
